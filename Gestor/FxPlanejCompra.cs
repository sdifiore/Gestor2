...
namespace Gestor
{
    public static class FxPlanejCompra
    {
        ...
        public static float VBCMes1(PlanejCompra planej)     // BR
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes1 : 0;
        ...
        public static float VBCMes2(PlanejCompra planej)     // BS
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes2 : 0;
        ...
        public static float VBCMes3(PlanejCompra planej)     // BT
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes3 : 0;
        ...
        public static float VBCMes4(PlanejCompra planej)     // BU
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes4 : 0;
        ...
        public static float VBCMes5(PlanejCompra planej)     // BV
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes5 : 0;
        ...
        public static float VBCMes6(PlanejCompra planej)     // BW
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes6 : 0;
        ...
        public static float VBCMes7(PlanejCompra planej)     // BX
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes7 : 0;
        ...
        public static float VBCMes8(PlanejCompra planej)     // BY
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes8 : 0;
        ...
        public static float VBCMes9(PlanejCompra planej)     // BZ
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes9 : 0;
        ...
        public static float VBCMes10(PlanejCompra planej)     // CA
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes10 : 0;
        ...
        public static float VBCMes11(PlanejCompra planej)     // CB
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes11 : 0;
        ...
        public static float VBCMes12(PlanejCompra planej)     // CC
        {
            ...
            float result = planej.InsumoId != id ? planej.PrecoUnitarioBruto * planej.QCMes12 : 0;
        ...
        public static float VCCMes1(PlanejCompra planej)        // DN
        {
            ...
            float result = planej.InsumoId != id
