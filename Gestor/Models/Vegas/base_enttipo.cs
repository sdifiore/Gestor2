namespace Gestor.Models.Vegas
{
    ...
    [Table("vegas.base_enttipo")]
    public partial class base_enttipo
    {
        [Key]
        ...
        [Column(TypeName = "char")]
        [StringLength(1)]
        public string AJUSTAPROD { get; set; }
        ...
        [Column(TypeName = "char")]
        [StringLength(1)]
        public string DESCONHOMOLFORNEC { get; set; }
        ...
        [Column(TypeName = "char")]
        [StringLength(15)]
        public string NFE_OPERACAO { get; set; }

        [Column(TypeName = "char")]
        [StringLength(1)]
        public string NFE_OPCGERAR { get; set; }
        ...
        [Column(TypeName = "char")]
        [StringLength(1)]
        public string ROM_FORNMULT { get; set; }

        public decimal RESTR_QTD { get; set; }

        public decimal RESTR_VLUNT { get; set; }
