namespace Gestor.Models.Vegas
{
    ...
    [Table("vegas.base_pedtipo")]
    public partial class base_pedtipo
    {
        [Key]
        ...
        [Column(TypeName = "char")]
        [StringLength(9)]
        public string PEDSTATUSINI { get; set; }

        [Column(TypeName = "char")]
        [StringLength(9)]
        public string DETSTATUSINI { get; set; }
        ...
        [Column(TypeName = "char")]
        [StringLength(1)]
        public string GERA_ENTRADA { get; set; }
