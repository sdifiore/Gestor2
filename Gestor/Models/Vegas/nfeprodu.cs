namespace Gestor.Models.Vegas
{
    ...
    [Table("vegas.nfeprodu")]
    public partial class nfeprodu
    {
        [Key]
        ...
        public int? ICMS_BASE_MOD { get; set; }
        ...
        public decimal ICMS_B_MOD_SUB { get; set; }
        ...
        public decimal ICMS_ESPE_BASE { get; set; }

        public decimal ICMS_ESPE_ALIQ { get; set; }
        ...
        public decimal ICMS_ESPE_B_SUB { get; set; }

        public decimal ICMS_ESPE_ALIQST { get; set; }
        ...
        public decimal IPI_ESPE_BASE { get; set; }

        public decimal IPI_ESPE_ALIQ { get; set; }
        ...
        public decimal PIS_ESPE_BASE { get; set; }

        public decimal PIS_ESPE_ALIQ { get; set; }
        ...
        public Guid? COFINS_NATBCCRED_E { get; set; }

        [Column(TypeName = "char")]
        [StringLength(1)]
        public string COFINS_RETER { get; set; }

        public decimal COFINS_ESPE_BASE { get; set; }

        public decimal COFINS_ESPE_ALIQ { get; set; }
        ...
        public decimal II_BASE { get; set; }
