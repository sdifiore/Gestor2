...
namespace Gestor.Controllers
{
    public class ClasseCustoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Apelido,Descricao")] ClasseCusto classeCusto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Apelido,Descricao")] ClasseCusto classeCusto)
        {
            if (ModelState.IsValid)
            {
