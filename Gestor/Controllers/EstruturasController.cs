...
namespace Gestor.Controllers
{
    public class EstruturasController : Controller
    {
        ...
        {
            var estruturas = db.Estruturas.Include(e => e.Produto).Include(e => e.Sequencia);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.SequenciaId = new SelectList(db.Sequencias, "SequenciaId", "Descricao");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Apelido,ProdutoId,Onera,Observacao,SequenciaId")] Estrutura estrutura)
        {
            ...
            ViewBag.SequenciaId = new SelectList(db.Sequencias, "SequenciaId", "Descricao", estrutura.SequenciaId);
            return View(estrutura);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Apelido,ProdutoId,Onera,Observacao,SequenciaId")] Estrutura estrutura)
        {
            if (ModelState.IsValid)
            {
